...
from Backend_sandbox.rag_pipeline import get_agent_executor, add_to_vectorstore, split_docs
from Backend_sandbox.data_loader import load_uploaded_file, load_website
from Backend_sandbox.schemas import ChatQuery, ChatResponse, CrawlRequest
from Backend_sandbox.config import Config
from Backend_sandbox.utils import log_query
...
def get_session_agent(session_id: str):
    if session_id not in sessions:
        sessions[session_id] = get_agent_executor(session_id)
